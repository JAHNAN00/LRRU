...
LOG_FILE="$LOG_DIR/mini_20epoch_resume_watch.log"
STATUS_FILE="$LOG_DIR/mini_20epoch_resume_watch.status"
PID_FILE="$LOG_DIR/mini_20epoch_resume_watch.pid"
CONFIG="train_lrru_mini_20epoch_resume_kitti.yml"
MIN_FREE_GB="15"
CHECK_INTERVAL="30"
