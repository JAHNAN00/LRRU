...
LOG_FILE="$LOG_DIR/mini_5epoch_watch.log"
STATUS_FILE="$LOG_DIR/mini_5epoch_watch.status"
PID_FILE="$LOG_DIR/mini_5epoch_watch.pid"
CONFIG="train_lrru_mini_5epoch_kitti.yml"
MIN_FREE_GB="15"
CHECK_INTERVAL="30"
